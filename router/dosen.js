...
server.get('/dosen/listRPS/:id',controllers.dosen.listRPS) //"id = parameter"
server.get('/dosen/tambahRPS',controllers.dosen.tambahRPS)
// server.get('/dosen/tambahRPS/:id',controllers.dosen.tambahRPS)
// server.post('/dosen/tambahRPS/:id',controllers.dosen.tambahRPS)
...
server.post('/dosen/tambahCPMK',controllers.dosen.tambahCPMK)
